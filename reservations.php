...
<div class="menu-toggle" onclick="toggleMenu(this)">
    ...
    <div class="nav-links" id="navLinks" data-aos="fade-up">
        ...
        <a href="reservations.php" active>Reservation</a>
    ...
    <div class="list">
      <div class="item">
        ...
        <div class="content">
          ...
          <div class="topic" style="color: rgb(140, 255, 0);font-size: 56px">Reservation >> </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 mb-4" >
        ...
        <li><a href="reservations.php" active class="text-white text-decoration-none">Reservations</a></li>
...
<div id="bookingPopup" class="booking-popup shadow-lg">
  ...
  <div class="popup-body">
    ...
    <a href="#contact" class="btn btn-book btn-lg w-100 rounded-pill fw-semibold">Book Now</a>
  </div>
</div>
