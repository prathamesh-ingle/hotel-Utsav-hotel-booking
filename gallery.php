...
<div class="menu-toggle" onclick="toggleMenu(this)">
    ...
    <div class="nav-links" id="navLinks" data-aos="fade-up">
        ...
        <a href="gallery.php" active>Gallery</a>
    ...
    <div class="list">
      <div class="item">
        ...
        <div class="content">
          ...
          <div class="topic" style="color: rgb(140, 255, 0);">Gallery >> </div>
...
<section class="container">
  <div class="gallery-heading" data-aos="fade-up">
    <h2 class="text-warning fw-semibold mb-3">Our Gallery</h2>
        <hr class="border-2 border-warning w-14 mb-3">
    <p>Discover the elegance of Hotel Utsav Square through our curated photo gallery.</p>
  </div>

  <div class="row g-4">
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="100">
      <div class="gallery-img">
        <img src="image/b.jpg" alt="Gallery A" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="200">
      <div class="gallery-img">
        <img src="image/d.jpg" alt="Gallery B" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="300">
      <div class="gallery-img">
        <img src="image/n.jpg" alt="Gallery C" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="400">
      <div class="gallery-img">
        <img src="image/o.jpg" alt="Gallery D" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="500">
      <div class="gallery-img">
        <img src="image/e.jpg" alt="Gallery E" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="600">
      <div class="gallery-img">
        <img src="image/f.jpg" alt="Gallery F" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="700">
      <div class="gallery-img">
        <img src="image/l.jpg" alt="Gallery G" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800">
      <div class="gallery-img">
        <img src="image/h.jpg" alt="Gallery H" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="900">
      <div class="gallery-img">
        <img src="image/a.jpg" alt="Gallery I" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="1000">
      <div class="gallery-img">
        <img src="image/c.jpg" alt="Gallery J" class="img-fluid">
      </div>
    </div>
     <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="1000">
      <div class="gallery-img">
        <img src="image/m.jpg" alt="Gallery J" class="img-fluid">
      </div>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="1000">
      <div class="gallery-img">
        <img src="image/g.jpg" alt="Gallery J" class="img-fluid">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 mb-4" >
        ...
        <li><a href="gallery.php" active class="text-white text-decoration-none">Gallery</a></li>
